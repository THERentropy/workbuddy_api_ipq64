...
install_now() {
	...
	# 夜猫子（panel 版上游键名由 cat_* 改为 blackcat_*）
	dbus_set_default ${module}_blackcat_hours "23"
	...
	dbus_set_default ${module}_blackcat_enabled "1"
	# 余额后台刷新：两次签到之间保持积分新鲜，余额恢复的冷却账号自动解冻
	dbus_set_default ${module}_balance_refresh "1"
	dbus_set_default ${module}_balance_refresh_min "5"
	dbus_set_default ${module}_global_enabled "1"
	dbus_set_default ${module}_timeout "120"
	dbus_set_default ${module}_header_timeout "120"
	dbus_set_default ${module}_idle_timeout "300"
	dbus_set_default ${module}_client_name "WorkBuddy"
	dbus_set_default ${module}_passthrough_ip "0"
	...
	dbus_set_default ${module}_max_in_flight_global "2"
	...
	dbus_set_default ${module}_degrade_threshold "5"
	dbus_set_default ${module}_degrade_cooldown "10m"
	dbus_set_default ${module}_degrade_cooldown_max "2h"
